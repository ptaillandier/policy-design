...
#from gym.utils import passive_env_checker as passive_env_checker_gym
...
#Passes test but it crashes because the test runs step 11 times without reset
...
#    def test_gama_passive_checkenv_gym(self):
#        env = gym.make('GamaEnv-v0',
#                       headless_directory      = lv.headless_dir,
#                       headless_script_path    = lv.run_headless_script_path,
#                       gaml_experiment_path   = lv.gaml_file_path,
#                       gaml_experiment_name    = lv.experiment_name)
#
#        passive_env_checker_gym.check_env(env)

#    def test_gama_raycheckenv(self):
#        env = gym.make('GamaEnv-v0',
#                 headless_directory      = lv.headless_dir,
#                 headless_script_path    = lv.run_headless_script_path,
#                 gaml_experiment_path   = lv.gaml_file_path,
