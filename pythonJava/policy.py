    ...
    def bound_and_sample_actions(self, mussigmoid, logsigmassigmoid, budget):
        ...
        for dimension in dimensions_order:
            ...
            if dimension == 0:
                ...
                print('\t thetaeconomy', actions[0])
                print('\t prob(action)', distribution.prob(np.array([[actions[0]]])))
                print('\t logprob(action)', distribution.log_prob(np.array([[actions[0]]])))
            ...
            if dimension == 1:
                ...
                for subdimension in subdimensions_order:
                    ...
                    if subdimension == 0:
                        ...
                        print('\t thetamanagement', actions[1])
                        print('\t prob(action)', distribution.prob(np.array([[actions[1]]])))
                        print('\t logprob(action)', distribution.log_prob(np.array([[actions[1]]])))
                        ...
                        print('\t fractionmanagement', actions[2])
                        print('\t prob(action)', distribution.prob(np.array([[actions[2]]])))
                        print('\t logprob(action)', distribution.log_prob(np.array([[actions[2]]])))
            ...
            if dimension == 2:
                ...
                for subdimension in subdimensions_order:
                    ...
                    if subdimension == 0:
                        ...
                        print('\t thetaenvironment', actions[3])
                        print('\t prob(action)', distribution.prob(np.array([[actions[3]]])))
                        print('\t logprob(action)', distribution.log_prob(np.array([[actions[3]]])))
                    else:
                        ...
                        print('\t fractionenvironment', actions[4])
                        print('\t prob(action)', distribution.prob(np.array([[actions[4]]])))
                        print('\t logprob(action)', distribution.log_prob(np.array([[actions[4]]])))
